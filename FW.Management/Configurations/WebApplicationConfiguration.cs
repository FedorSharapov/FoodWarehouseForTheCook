...
namespace FW.Management.Configurations
{
    public static class WebApplicationConfiguration
    {
        public static WebApplication Configure(WebApplicationBuilder builder)
        {
            ...
            eventBus.Subscribe<ChangesProductsGetPageEventHandler, ChangesProductsGetPageDto>(queueNames.ChangesProducts.GetPage, exchangeNames.ChangesProducts);
            ...
            eventBus.Subscribe<WarehouseGetByUserIdEventHandler, WarehouseGetByUserIdDto>(queueNames.Warehouses.GetByUserId, exchangeNames.Warehouses);
